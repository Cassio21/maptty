...
class App {
  ...
  _newWorkout(e) {
    ...
    // 👉🏻 se a atividade correr  estiver em execução, criar um objeto em exucução
    if (type === 'running') {
    ...
    // 👉🏻 adicionar o novo objeto a matiz de trabalho
    this.#workouts.push(workout);

    // 👉🏻 renderizar o treino no mapa como um marcador.
    this._renderWorkoutMarker(workout);

    // 👉🏻 renderizaar o novo treino na lista.
    this._renderWorkout(workout);

    //  // 👉🏻  ocultar o formulário + clear input fields | Campos de entrada claros
    this._hideForm();

    // 👉🏻  definindo o armazenamento  local para todos os exercicios.
